...
class ContextStack implements Map<String, Object> {
    ...
    public Map<String, Object> pop() {
        return (this.stackList.size() > 1) ? stackList.remove(0) : null
    }
    ...
    public ContextStack clone() {
        ...
        newStack.stackList.addAll(this.stackList)
        return newStack
    }
    ...
    public boolean isEmpty() {
        for (Map<String, Object> curMap in this.stackList) {
    ...
    public Object put(String key, Object value) {
        return this.stackList[0].put(key, value)
    }

    /** @see java.util.Map#remove(java.lang.Object) */
    @Override
    public Object remove(Object key) {
        return this.stackList[0].remove(key)
    }

    /** @see java.util.Map#putAll(java.util.Map) */
    @Override
    public void putAll(Map<? extends String, ? extends Object> arg0) {
        this.stackList[0].putAll(arg0)
    }

    /** @see java.util.Map#clear() */
    @Override
    public void clear() {
        this.stackList[0].clear()
    }
    ...
    public Set<String> keySet() {
        ...
        for (Map curMap in this.stackList) {
