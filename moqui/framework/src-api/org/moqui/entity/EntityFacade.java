...
public interface EntityFacade {
   ...
   /** Store a group of values
     ...
     */
    int updateByCondition(String entityName, Map<String, ?> fieldsToSet, EntityCondition condition) throws EntityException;
     ...
     */
    EntityValue findOne(String entityName, Map<String, ?> fields, boolean useCache) throws EntityException;

    /** Finds EntityValues by the conditions specified in the EntityCondition object, the the EntityCondition javadoc for more details.
     *@param entityName The name of the Entity as defined in the entity XML file
     ...
     *@param orderBy The fields of the named entity to order the query by; optionally add a " ASC" to the end or "+" to the beginning for ascending, or " DESC" to the end of "-" to the beginning for descending
    ...
    /** Finds EntityValues by the conditions specified in the EntityCondition object, the the EntityCondition javadoc for more details.
     *@param dynamicView The EntityDynamicView to use for the entity model for this query; generally created on the fly for limited use
     *@param whereEntityCondition The EntityCondition object that specifies how to constrain this query before any groupings are done (if this is a view entity with group-by aliases)
     *@param havingEntityCondition The EntityCondition object that specifies how to constrain this query after any groupings are done (if this is a view entity with group-by aliases)
     *@param fieldsToSelect The fields of the named entity to get from the database; if empty or null all fields will be retreived
     *@param orderBy The fields of the named entity to order the query by; optionally add a " ASC" to the end or "+" to the beginning for ascending, or " DESC" to the end of "-" to the beginning for descending
     ...
     */
    EntityListIterator findDynamicView(EntityDynamicView dynamicView, EntityCondition whereEntityCondition,
     ...
     */
    List<EntityValue> findRelated(String relationName, Map<String, ?> byAndFields, List<String> orderBy, EntityValue value) throws EntityException;
